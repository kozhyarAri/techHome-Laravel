...
@section('content')
    ...
    @endif
    <form enctype="multipart/form-data" class="w-full mx-auto" method="POST" action="{{ route('device.store') }}">
        @csrf
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
            ...
            <div class="mb-5">
                <label for="main_camera" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Main
                    Camera</label>
                <input type="text" id="main_camera" name="main_camera" value="{{ old('main_camera') }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div class="mb-5">
                <label for="selfie_camera" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Selfie
                    Camera</label>
                <input type="text" id="selfie_camera" name="selfie_camera" value="{{ old('selfie_camera') }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
